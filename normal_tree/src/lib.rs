...
#[derive(Clone)]
pub struct NomalTreeNode(u32, Option<Box<Self>>, Option<Box<Self>>);
...
impl NomalTreeNode {
    ...
    pub fn some_leaf(value: u32) -> Option<Box<Self>> {
    ...
    pub fn random(lower_limit: u32, higher_limit: u32) -> Self {
        loop {
